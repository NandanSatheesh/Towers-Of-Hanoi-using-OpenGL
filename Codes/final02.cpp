...
void select(int ch)
{
	switch(ch)
	{
		case 1 : printf("1"); r = g =  b = 0.5 ; glutPostRedisplay(); break  ; 
		case 2 : printf("2"); r = g = b = 0.123 ; glutPostRedisplay(); break ;
		case 3 : printf("3");r = g = b = 4 ; glutPostRedisplay(); break ; 
...
void initialize_game()
{
	...
	double dx = (t_board.x_max - t_board.x_min) / 4.0; //Since 3 rods
...
{ 
	...
	drawStrokeText("A Project by Nandan A.S.",500,600,0);
	
	drawStrokeText("Press N to go to the next screen",200,400,0);
